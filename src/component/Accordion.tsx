...
const Accordion = ({
  ...
  data: { name: string; description: string; elements: string[] }[];
}) => {
  const [toggleAccordion, setToggleAccordion] = useState<number | undefined>(
    undefined
  );
  ...
  return (
    <AccordionParent>
      {data.map(
        (
          item: { name: string; description: string; elements: string[] },
          index: number
        ) => {
          return (
            <AccordionContainer key={index}>
              ...
              <AccordionContent index={index} toggle={toggleAccordion}>
                ...
                <NavLinkStyle to={`/${type}/${category}/${item.name}`}>
                  En savoir plus
                </NavLinkStyle>
              </AccordionContent>
            </AccordionContainer>
